...
export default function About() {
    return (
        <>
            <div className="fixed w-full h-full top-0 left-0 z-[-1]" style={{ opacity: '0.5' }}>
                <Lottie options={defaultOptions} />
                </div>
                    <div className="mb-5">
                        <div className="grid grid-cols-6 gap-4 items-center justify-center h-screen">
                            <div className="lg:col-start-2 lg:col-end-4 col-start-1 col-end-7 text-4xl sm:text-7xl font-bold text-slate-700">
                                HI THERE!<br />
                                IT'S<br />
                                MELISSA
                            </div>
                            <div className="lg:col-start-4 lg:col-end-6">
                                <Image src={profilePhoto} className="img-fluid rounded-pill" style={{ border: '2px solid black', maxHeight: '400px' }}></Image>
                            </div>
                        </div>

                        <div className="grid grid-cols-6 gap-4 mt-5 items-center justify-center h-screen">
                            <div className="lg:col-start-2 lg:col-end-6 mt-5 col-start-1 col-end-7">
                        ...
                        <div className="grid grid-cols-6 gap-4 mt-5 items-center justify-center h-screen">
                            ...
                            <div className="lg:col-start-4 lg:col-end-6">
                                ...
                                <div className="mt-3 ">
                                    ...
                                    <div className="mt-2 text-base sm:text-lg text-slate-600"><DownhillSkiingIcon className="mr-4" sx={{ color: orange[500] }} />Skiing</div>
